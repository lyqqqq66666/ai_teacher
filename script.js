...
const demoSampleProfiles = {
  ...
  math: {
    // 竖版：分数加减订正页（解方程 + 工程 + 蔬菜种植表）
    aspect: "950 / 1348",
    frames: [
      { left: "6%", top: "8%", width: "88%", height: "22%", tone: "amber" }, // 2. 解方程三小题
      { left: "6%", top: "32%", width: "88%", height: "22%" }, // 3. 工程队应用题
      { left: "6%", top: "56%", width: "88%", height: "38%", tone: "amber" }, // 4. 表格 + 两问
    ],
    top3: [
      "解方程移项 / 通分符号错误",
      "工程问题数量关系列式不稳",
